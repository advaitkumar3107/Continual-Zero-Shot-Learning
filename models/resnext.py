...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None, *args, **kwargs):
...
class ResNeXtBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, cardinality, stride=1,
                 downsample=None, *args, **kwargs):
        super().__init__(inplanes, planes, stride, downsample, *args, **kwargs)
...
class ResNeXt(ResNet):
    ...
    def __init__(self,
        ...
        super().__init__(block, layers, block_inplanes, n_input_channels,
                         ...
                         shortcut_type, n_classes, *args, **kwargs)
